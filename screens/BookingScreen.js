...
class BookingScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.navigation.addListener('willFocus', (route) => {
      ...
      this.props.fetchBookingList({ "bookingType": "1", "userMobile": this.props.auth.token.MobileNo1 });
    });
  }
  ...
  renderItem = ({ item }) => {
    // console.log("------item kkkkk ---" + JSON.stringify(item));
  ...
  render() {
    ...
    resp = this.props.bookings.bookingListResp1;
    // console.log("this.props.bookings.bookingListResp.BookingList ==== " + JSON.stringify(this.props.bookings.bookingListResp1.BookingList));
  ...
  _onBookingListItemClick = (item) => {
    ...
    // console.log("------item cccccc ---" + JSON.stringify(item));
...
const mapStateToProps = state => ({
  ...
  isFetching1: state.bookings.isFetching1,
  auth: state.auth
});

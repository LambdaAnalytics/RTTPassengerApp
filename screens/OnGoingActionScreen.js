...
class OnGoingActionScreen extends React.Component {
  ...
  componentDidMount() {
    this.props.navigation.addListener('willFocus', (route) => {
      ...
      this.props.fetchBookingList({ "bookingType": "5", "userMobile": this.props.auth.token.MobileNo1 });
    });
  }
  ...
  render() {
    ...
    resp = this.props.bookings.bookingListResp5;
    // console.log("this.props.bookings.bookingListResp.BookingList ==== " + JSON.stringify(resp));
...
const mapStateToProps = state => ({
  ...
  isFetching5: state.bookings.isFetching5,
  auth: state.auth
});

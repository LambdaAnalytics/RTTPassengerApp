...
import { userRequestLogout, fetchBookingList,getTripStatus } from "../actions";
...
class BookingScreen2 extends React.Component {
    ...
    componentDidMount() {
        this.props.navigation.addListener('willFocus', (route) => {
            ...
            this.props.fetchBookingList({ "bookingType": "2", "userMobile": this.props.auth.token.MobileNo1 });
        });
    }
                    ...
                    <View>
                              <View style={styles.info}>
                                   <View style={{ flex: 1.3 }}>
                                        ...
                                        <View style={{ flex: 2 }}>
                                        <Text style={{ color: 'green' }}> {item.TripOtp ? item.TripOtp : '-NA-'} </Text>
                                        </View>
                                </View>
                    </View>
                    <View>
                    ...
                    <View style={styles.contentRow}>
                      ...
                      */}
                        ...
                        <View>
                            <View style={styles.info}>
                                <View style={{ flex: 1.3 }}>
                                    <Text> Drivers's Contact </Text>
                                </View>
                                <View style={{ flex: 2 }}>
                                    <Text> {item.DriverMobileNo} </Text>
                                </View>
                            </View>
                        </View>
    ...
    render() {
        ...
        resp = this.props.bookings.bookingListResp2;
        // console.log("this.props.bookings.bookingListResp.BookingList ==222== " + JSON.stringify(resp));
    ...
    _onBookingListItemClick = (item) => {
        ...
        this.props.getTripStatus(item.BookingId).then((data) => {

            if(data.BookingList[0].TripStatus == null || data.BookingList[0].TripStatus == "null" || data.BookingList[0].TripStatus == ""){   
                alert(" Trip Not Started ");
               
            } else if(data.BookingList[0].TripStatus == 1 || data.BookingList[0].TripStatus == 2){
...
const mapStateToProps = state => ({
    ...
    auth: state.auth,
    isFetching2: state.bookings.isFetching2
});

const mapDispatchToProps = dispatch => ({
    fetchBookingList: (data) => dispatch(fetchBookingList(data)),
    getTripStatus: (data) => dispatch(getTripStatus(data))
